...
import snekmate.tokens.interfaces.IERC721Metadata as IERC721Metadata
import snekmate.tokens.interfaces.IERC721Enumerable as IERC721Enumerable
import snekmate.tokens.interfaces.IERC721Receiver as IERC721Receiver
import snekmate.tokens.interfaces.IERC721Permit as IERC721Permit
import snekmate.tokens.interfaces.IERC4906 as IERC4906
import snekmate.utils.interfaces.IERC5267 as IERC5267

implements: ERC165 # ERC165 - Standard Interface Detection.
# implements: ERC721 # ERC721 - NFT Standard.
implements: IERC721Metadata # ERC-721 NFT Standard metadata extension.
implements: IERC721Enumerable # ERC-721 NFT Standard enumeration extension.
implements: IERC4906 # ERC-4906 - NFT Standard metadata update.
implements: IERC5267 # ERC-5267 - Retrieval of ERC-721 NFTs domain interface.
...
def transferFrom(owner: address, to: address, token_id: uint256):
    ...
    @param token_id The 32-byte identifier of the token.
    """
    assert self._is_approved_or_owner(msg.sender, token_id), "ERC721: caller is not token owner"
