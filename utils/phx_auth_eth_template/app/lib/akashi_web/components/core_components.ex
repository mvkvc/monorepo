defmodule AkashiWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :info && "bg-zinc-50 text-zinc-800 ring-zinc-500 fill-zinc-900",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AkashiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AkashiWeb.Gettext, "errors", msg, opts)
    end
  end
