...
#
#     PHX_SERVER=true bin/akashi_escrow start
#
...
if config_env() == :prod do
  database_url =
    System.get_env("APP_DB_URL") ||
      raise """
      environment variable DAPPS_ESCROW_DB_URL is missing.
  ...
  config :akashi, Akashi.Repo,
    ...
    ssl_opts: [
      ...
      cacertfile: Path.join(:code.priv_dir(:akashi), "cert/cacert.pem"),
      verify: :verify_peer,
