...
#
#     PHX_SERVER=true bin/critique start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :critique, CritiqueWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :critique, Critique.Repo,
    ...
    ssl_opts: [
      ...
      cacertfile: Path.join(:code.priv_dir(:critique), "cert/cacert.pem"),
      verify: :verify_peer,
  ...
  #
  #     config :critique, Critique.Mailer,
