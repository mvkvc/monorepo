defmodule Exboost.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Exboost.Repo)
  ...
  """
  def valid_password?(%Exboost.Accounts.User{hashed_password: hashed_password}, password)
  ...
  def llm_changeset(user, attrs \\ %{}, require_all \\ false) do
    user
    |> cast(attrs, [:llm_model, :llm_base_url, :llm_api_key, :search_engine, :search_api_key])
    |> validate_required(
      if require_all,
        do: [:llm_model, :llm_base_url, :llm_api_key, :search_engine, :search_api_key],
        else: [:search_engine]
    )
