...
from transformers import AutoTokenizer, GemmaConfig
# from transformers import AutoModelForCausalLM
from transformers import GemmaForCausalLM
# from nlp_demos.phi3.utils.modeling_phi3 import Phi3ForCausalLM


def run_gemma_causal_lm(variant="google/gemma-2b", batch_size=1):
    ...
    config = GemmaConfig.from_pretrained(model_ckpt)
    ...
    model = GemmaForCausalLM.from_pretrained(model_ckpt, config=config)
    model.eval()
