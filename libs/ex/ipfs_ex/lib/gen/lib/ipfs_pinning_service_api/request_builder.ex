...
defmodule IPFSPinningServiceAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    IPFSPinningServiceAPI.Deserializer.jason_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    IPFSPinningServiceAPI.Deserializer.jason_decode(body, module)
  end
end
