...
defmodule IPFSPinningServiceAPI.Connection do
  @moduledoc """
  Handle Tesla connections for IPFSPinningServiceAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, IPFSPinningServiceAPI.Connection,
        base_url: "https://pinning-service.example.com",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :ipfs_pinning_service_api,
        :base_url, "https://pinning-service.example.com"
  """
  ...
  @default_base_url Application.compile_env(
                      ...
                      :base_url,
                      "https://pinning-service.example.com"
                    )
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:ipfs_pinning_service_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - IPFSPinningServiceAPI 1.0.0 - elixir"
        )
      )
